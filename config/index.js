...
module.exports = {
  // 每日说配置项（必填项）
  NAME: "薛珍妮", //女朋友备注姓名
  NICKNAME: "Jeeny Xue", //女朋友昵称
  MEMORIAL_DAY: "2022/09/30", //你和女朋友的纪念日
  CITY: "武汉", //女朋友所在城市（城市名称，不要带“市”）
  SENDDATE: "0 20 5 * * *", // "0 19 17 * * *", //定时发送时间 每天8点06分0秒发送，规则见 /schedule/index.js
  TXAPIKEY: "75956fcbc9e973c1a33fd112dbfa12ca", //此处须填写个人申请的天行apikey,请替换成自己的 申请地址https://www.tianapi.com/signup.html?source=474284281

  // 高级功能配置项（非必填项）
  // AUTOREPLY: false, //自动聊天功能 默认开启, 关闭设置为: false
  // DEFAULTBOT: "0", //设置默认聊天机器人 0 天行机器人 1 图灵机器人 2 天行对接的图灵机器人，需要到天行机器人官网充值（50元/年，每天1000次）
  // AUTOREPLYPERSON: ["风回庭芜绿"], //指定多个好友开启机器人聊天功能   指定好友的备注，最好不要带有特殊字符
